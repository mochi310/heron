    ...
    // 3Dビューを描画. Draw the 3dview.
    {
      ...
      for(let angle=leftAngle; angle<rightAngle-0.01; angle+=fov/beamTotal) {
        ...
        let lineBegin = viewRect.begin.add(
          new Vec2(
            // viewRect.way.x/(beamTotal*beamIndex) じゃないよ！
